...
func NewConfigLoader() (ConfigLoader, error) {
	...
	// App settings
	cfg.App.Name = getEnvStrOrDefault("APP_NAME", "lms-book-service")
	...
	cfg.Server.Port = getEnvStrOrDefault("SERVER_PORT", "40042")
	...
	cfg.Database.DBName = getEnvStrOrDefault("DB_NAME", "lms_book_db")
	cfg.Database.DBSSLMode = getEnvStrOrDefault("DB_SSL_MODE", "disable")
	cfg.Database.DBMaxOpenConns = getEnvIntOrDefault("DB_MAX_OPEN_CONNS", 50)
	cfg.Database.DBMaxIdleConns = getEnvIntOrDefault("DB_MAX_IDLE_CONNS", 50)
