...
func (c *userServiceClient) UpdateVIPAccount(ctx context.Context, in *UpdateVIPAccountRequest, opts ...grpc.CallOption) (*UpdateVIPAccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateVIPAccountResponse)
	err := c.cc.Invoke(ctx, UserService_UpdateVIPAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) DeleteUsers(ctx context.Context, in *DeleteUsersRequest, opts ...grpc.CallOption) (*v1.BaseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) UpdateVIPAccount(context.Context, *UpdateVIPAccountRequest) (*UpdateVIPAccountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateVIPAccount not implemented")
}
...
func _UserService_UpdateVIPAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateVIPAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).UpdateVIPAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_UpdateVIPAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateVIPAccount(ctx, req.(*UpdateVIPAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateVIPAccount",
			Handler:    _UserService_UpdateVIPAccount_Handler,
		},
		{
